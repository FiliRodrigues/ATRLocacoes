...
class VehicleData {
  ...
  VehicleData({required this.nome, required this.placa, required this.motorista, required this.telefoneMotorista, required this.status, required this.mesesEmServico, required this.kmPorMes, this.imagemAsset, required this.cor1, required this.cor2, this.financiamento, required this.manutencoes});
...
final List<VehicleData> frota = [
  VehicleData(
    ...
    manutencoes: const [
      MaintenanceEvent(data: '15/07/2023', tipo: 'Revisão', kmNoServico: 10000, custo: 1050, descricao: 'Revisão 10k - Troca de óleo e filtros'),
      MaintenanceEvent(data: '20/11/2023', tipo: 'Revisão', kmNoServico: 20000, custo: 1150, descricao: 'Revisão 20k - Troca óleo, filtros e alinhamento'),
      MaintenanceEvent(data: '10/03/2024', tipo: 'Revisão', kmNoServico: 30000, custo: 1100, descricao: 'Revisão 30k - Troca de óleo e filtros'),
      MaintenanceEvent(data: '25/06/2024', tipo: 'Revisão', kmNoServico: 40000, custo: 1250, descricao: 'Revisão 40k - Troca pastilhas de freio + óleo'),
      MaintenanceEvent(data: '15/10/2024', tipo: 'Revisão', kmNoServico: 50000, custo: 1300, descricao: 'Revisão 50k - Troca correia dentada + óleo'),
      MaintenanceEvent(data: '01/01/2025', tipo: 'Revisão', kmNoServico: 60000, custo: 1100, descricao: 'Revisão 60k - Troca de óleo e filtros'),
      MaintenanceEvent(data: '20/05/2025', tipo: 'Revisão', kmNoServico: 70000, custo: 1150, descricao: 'Revisão 70k - Troca óleo, filtros e amortecedores'),
      MaintenanceEvent(data: '10/08/2025', tipo: 'Revisão', kmNoServico: 80000, custo: 1200, descricao: 'Revisão 80k - Troca pastilhas e discos de freio'),
      MaintenanceEvent(data: '01/12/2025', tipo: 'Revisão', kmNoServico: 90000, custo: 1050, descricao: 'Revisão 90k - Troca de óleo e filtros'),
      MaintenanceEvent(data: '20/03/2026', tipo: 'Revisão', kmNoServico: 100000, custo: 1200, descricao: 'Revisão 100k - Revisão completa + correia'),
    ],
  ),
  VehicleData(
    ...
    manutencoes: const [
      MaintenanceEvent(data: '01/07/2024', tipo: 'Revisão', kmNoServico: 10000, custo: 1200, descricao: 'Revisão 10k - Troca de óleo e filtros'),
      MaintenanceEvent(data: '05/10/2024', tipo: 'Revisão', kmNoServico: 20000, custo: 1150, descricao: 'Revisão 20k - Troca óleo, filtros e alinhamento'),
      MaintenanceEvent(data: '15/01/2025', tipo: 'Revisão', kmNoServico: 30000, custo: 1200, descricao: 'Revisão 30k - Troca de óleo e filtros'),
      MaintenanceEvent(data: '20/04/2025', tipo: 'Revisão', kmNoServico: 40000, custo: 1300, descricao: 'Revisão 40k - Troca pastilhas de freio + óleo'),
      MaintenanceEvent(data: '01/08/2025', tipo: 'Revisão', kmNoServico: 50000, custo: 1200, descricao: 'Revisão 50k - Troca correia dentada + óleo'),
      MaintenanceEvent(data: '10/11/2025', tipo: 'Revisão', kmNoServico: 60000, custo: 1150, descricao: 'Revisão 60k - Troca de óleo e filtros'),
      MaintenanceEvent(data: '15/02/2026', tipo: 'Revisão', kmNoServico: 70000, custo: 1250, descricao: 'Revisão 70k - Troca amortecedores + óleo'),
    ],
  ),
  VehicleData(
    ...
    manutencoes: const [
      MaintenanceEvent(data: '10/03/2023', tipo: 'Revisão', kmNoServico: 10000, custo: 1050, descricao: 'Revisão 10k - Troca de óleo e filtros'),
      MaintenanceEvent(data: '15/07/2023', tipo: 'Revisão', kmNoServico: 20000, custo: 1100, descricao: 'Revisão 20k - Troca óleo, filtros e alinhamento'),
      MaintenanceEvent(data: '20/11/2023', tipo: 'Revisão', kmNoServico: 30000, custo: 1100, descricao: 'Revisão 30k - Troca de óleo e filtros'),
      MaintenanceEvent(data: '25/03/2024', tipo: 'Revisão', kmNoServico: 40000, custo: 1150, descricao: 'Revisão 40k - Troca pastilhas de freio + óleo'),
      MaintenanceEvent(data: '01/07/2024', tipo: 'Revisão', kmNoServico: 50000, custo: 1200, descricao: 'Revisão 50k - Troca correia dentada + óleo'),
      MaintenanceEvent(data: '10/11/2024', tipo: 'Revisão', kmNoServico: 60000, custo: 1050, descricao: 'Revisão 60k - Troca de óleo e filtros'),
      MaintenanceEvent(data: '15/03/2025', tipo: 'Revisão', kmNoServico: 70000, custo: 1100, descricao: 'Revisão 70k - Troca de óleo e filtros'),
      MaintenanceEvent(data: '20/07/2025', tipo: 'Revisão', kmNoServico: 80000, custo: 1150, descricao: 'Revisão 80k - Troca pastilhas e discos + óleo'),
      MaintenanceEvent(data: '01/11/2025', tipo: 'Revisão', kmNoServico: 90000, custo: 1100, descricao: 'Revisão 90k - Troca de óleo e filtros'),
      MaintenanceEvent(data: '10/03/2026', tipo: 'Revisão', kmNoServico: 100000, custo: 1200, descricao: 'Revisão 100k - Revisão completa + correia'),
    ],
  ),
  VehicleData(
    ...
    manutencoes: const [
      MaintenanceEvent(data: '10/09/2025', tipo: 'Revisão', kmNoServico: 10000, custo: 1050, descricao: 'Revisão 10k - Troca de óleo e filtros'),
      MaintenanceEvent(data: '15/01/2026', tipo: 'Revisão', kmNoServico: 20000, custo: 1050, descricao: 'Revisão 20k - Troca óleo, filtros e alinhamento'),
    ],
  ),
];

final List<DriverData> motoristas = [
  const DriverData(nome: 'João Silva', telefone: '(11) 98888-1234', vencimentoCNH: '12/10/2026', statusCNH: 'ok', multas: 0, placasVeiculos: ['VD-1234', 'ARG-1D23']),
  const DriverData(nome: 'Marcos Antônio', telefone: '(11) 97777-5678', vencimentoCNH: '14/05/2026', statusCNH: 'vencendo', multas: 2, placasVeiculos: ['TX-2041']),
  const DriverData(nome: 'Roberto Carlos', telefone: '(11) 99999-0000', vencimentoCNH: '01/01/2024', statusCNH: 'vencida', multas: 0, placasVeiculos: ['ARG-4H78']),
];
...
List<AlertItem> get frotaAlertas {
  ...
  for (final d in motoristas) {
    if (d.statusCNH == 'vencida') a.add(AlertItem(tipo: 'danger', titulo: 'CNH Vencida', mensagem: '${d.nome} - CNH vencida em ${d.vencimentoCNH}. Regularizar imediatamente.'));
    if (d.statusCNH == 'vencendo') a.add(AlertItem(tipo: 'warning', titulo: 'CNH Vencendo', mensagem: '${d.nome} - CNH vence em ${d.vencimentoCNH}. Agendar renovação.'));
  }
